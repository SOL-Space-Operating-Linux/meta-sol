...
EXTRA_OEMAKE += "'CC=${CC}' 'CXX=${CXX}' 'NVCC=${STAGING_DIR_HOST}/${baselibdir}/usr/local/cuda-${CUDA_VERSION}/bin/nvcc -ccbin ${CC_BIN}' 'GPU=1' 'CUDNN=1' 'LDFLAGS=--hash-style=gnu'"
S = "${WORKDIR}/git"
...
DEPENDS = "cudnn cuda-nvcc cuda-cusolver cuda-cublas cuda-cudart cuda-curand"
